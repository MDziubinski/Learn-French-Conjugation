...
import 'package:french_conjugation_learn/presentation/widget/tasks/multi_choice_task/cubit/multi_choice_task_cubit.dart';
import 'package:hooked_bloc/hooked_bloc.dart';

class MultiChoiceTask extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final cubit = useBloc<MultiChoiceTaskCubit>();
